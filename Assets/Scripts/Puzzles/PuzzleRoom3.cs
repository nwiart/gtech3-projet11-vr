...
public class PuzzleRoom3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _socketsInOrder[3].selectEntered.AddListener((args) => { OnAttach(3, args); });
        _socketsInOrder[4].selectEntered.AddListener((args) => { OnAttach(4, args); });
    }
